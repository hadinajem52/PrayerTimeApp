 ...
 *
 * Note that a third-party app cannot draw *text* in the status bar on Android 15
 * or below - only an icon. The digits live in the shade.
 *
...
export async function showCountdownNotification(locationData, language = 'en', now = new Date()) {
  ...
  await notifee.displayNotification({
    ...
    title: translateNotification(language, next.key),
    body: translateNotification(language, 'countdownBody'),
    android: {
