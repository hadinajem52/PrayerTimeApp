export const TRANSLATIONS = {
  en: {
    ...
    adhanVoiceSetting: "Muezzin",
    adhanFullVersionSetting: "Full Adhan",
    adhanFullVersionDescription: "Play the complete adhan instead of the shortened version",
  ...
  ar: {
    ...
    disclaimer: "جميع المواقيت طبقًا لرأي سماحة الإمام الخامنئي (رضوان الله عليه)",
    ...
    adhanVoiceSetting: "المؤذن",
    adhanFullVersionSetting: "الأذان الكامل",
    adhanFullVersionDescription: "تشغيل الأذان كاملاً بدلاً من النسخة المختصرة",
    playPreview: "استماع",
    pausePreview: "إيقاف",
